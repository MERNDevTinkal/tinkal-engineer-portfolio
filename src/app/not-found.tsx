...
import { motion } from 'framer-motion'; // If used as client component
...
// "use client"; // Uncomment if using client-side framer-motion

export default function NotFoundPage() {
  return (
    <SectionWrapper id="not-found-page" className="min-h-screen flex items-center justify-center bg-background">
      {/* If using framer-motion, wrap with motion.div and add "use client" */}
      {/* <motion.div
